# Presets.ps1 - Color preset definitions for the SVG Generator.
# Dot-source this file to get $ColorPresets and Get-PresetList.

# [ordered] preserves the definition order, matching the Python version.
$script:ColorPresets = [ordered]@{
    'red'            = @(255, 0, 0)
    'green'          = @(0, 255, 0)
    'blue'           = @(0, 0, 255)
    'yellow'         = @(255, 255, 0)
    ...
    'darker'         = @(13, 17, 23)
    'black'          = @(0, 0, 0)
    # Pastel colors in alphabetical order
...
function Get-PresetList {
    <#
    .SYNOPSIS
        Returns the names of all available color presets.
    #>
    return @($script:ColorPresets.Keys)
}
